...
namespace output
{
 ...
 const struct names::gn_data names::data[LAST_TYPE] =
 {
    ...
    { OUT_TOTAL_SAMPLE_POS, "out_total_sample_pos", iocat::SAMP_T,  "The number of samples processed in total." },
    ...
    { OUT_COUNT,            "out_count",            iocat::WCINT_T,   "Outputs a count of events, ie triggers." },
