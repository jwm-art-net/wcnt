...
void const* lpfilter::get_in(inputnames::IN_TYPE it)
{
    switch(it)
    {
    case inputnames::IN_SIGNAL:
...
void const* lpfilter::get_param(paramnames::PAR_TYPE pt)
{
    switch(pt)
    {
    case paramnames::PAR_FEED_LEVEL:
...
void lpfilter::create_params()
{
    ...
    get_paramlist()->add_param(
     synthmodnames::MOD_LPFILTER, paramnames::PAR_FEED_LEVEL);
    get_paramlist()->add_param(
     synthmodnames::MOD_LPFILTER, paramnames::PAR_FEED_MODSIZE);
    get_paramlist()->add_param(
