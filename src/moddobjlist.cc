...
{
	return (moddobj*)(moddobj_item = moddobj_list->add_at_tail(mo))->get_data();
}

moddobj* 
moddobjlist::add_moddobj(	synthmodnames::SYNTH_MOD_TYPE smt,	
...
moddobjlist* 
moddobjlist::get_moddobjlist_for_moduletype(synthmodnames::SYNTH_MOD_TYPE smt)
{
