...
void adsr_coord::register_ui()
{
    ...
    register_param(param::TIME, "Specify section time for both upper and lower shapes.")
                                    ...
                                    ->set_flags(ui::UI_OPTION1);
    register_param(param::UPTIME)->set_flags(ui::UI_OPTION2 | ui::UI_OPT_DUPLICATE);
    register_param(param::LOTIME)->set_flags(ui::UI_OPTION2 | ui::UI_OPT_DUPLICATE);
