...
void adsr_coord::register_ui()
{
    ...
    register_param(param::UPTIME)->set_flags(ui::UI_OPTION1);
    register_param(param::UPLEVEL)->set_flags(ui::UI_OPTION1);
    register_param(param::LOTIME)->set_flags(ui::UI_OPTION1);
    register_param(param::LOLEVEL)->set_flags(ui::UI_OPTION1);
    register_comment(" - OR - ");
