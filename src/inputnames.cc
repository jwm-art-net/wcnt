...
// resonance amplitude modulation been removed as the resonant 
// code did not produce adequate emulation of resonance!
// inname[IN_RES_AMP_MOD] = "in_res_amp_mod";			incat[IN_RES_AMP_MOD] = CAT_DOUBLE;
	...
	// wcnt 1.1001 :-
	inname[IN_BAR] = "in_bar";							incat[IN_BAR] = CAT_SHORT;
	inname[IN_BAR_TRIG] = "in_bar_trig";				incat[IN_BAR_TRIG] = CAT_TRIG;
	inname[IN_POS_STEP_SIZE] = "in_pos_step_size";		incat[IN_POS_STEP_SIZE] = CAT_DOUBLE;
	inname[IN_WRITE_TRIG] = "in_write_trig";			incat[IN_WRITE_TRIG] = CAT_TRIG;
	inname[IN_STOP_TRIG] = "in_stop_trig";				incat[IN_STOP_TRIG] = CAT_TRIG;
