...
const paramnames::param_data paramnames::data[LAST] =
{
    ...
    { START_POS_MIN,    "start_pos_min",        iocat::SAMP_T   },
    { START_POS_MAX,    "start_pos_max",        iocat::SAMP_T   },
    { LOOP_BEGIN,       "loop_start_pos",       iocat::SAMP_T   },
    { LOOP_END,         "loop_end_pos",         iocat::SAMP_T   },
    ...
    { B,                "b",                    iocat::DOUBLE  },
    { C,                "c",                    iocat::DOUBLE  },
    { TEST_ITER,        "test_iterations",      iocat::SAMP_T  },
    ...
    { INSPECT_UL_MSG,   "_samp_t_msg_",         iocat::STRING  },
