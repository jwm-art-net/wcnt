...
namespace param
{
 const struct names::gn_data names::data[LAST_TYPE] =
 {
    ...
    { RELEASE_RATIO,    "release_is_ratio",     iocat::STATE,   "Whether to treat release level as a ration when release stage activates. Should be on for shaping amplitudes." },
    ...
    { INSPECT_UL_MSG,   "_samp_t_msg_",         iocat::STRING,  "Message to display when samp_t value triggered."  },
