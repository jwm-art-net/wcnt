...
namespace dataobj
{
 ...
 {
    { ERR_TYPE,         "BAD OBJECT TYPE",  CAT_ERR_TYPE,"ERROR!"                                   },
    ...
    { DEF_RIFF,         "riff",             CAT_DEF,    "Contains a sequence of notes for a sequencer to process."      },
    { DEF_WCFILE,       "synth_file_reader",CAT_DEF,    "Allows one .wc file to include the contents specified in another .wc file. Modules and data objects which are listed can either be excluded or the only contents included." },
    { DEF_PARAMEDITOR,  "param_editor",     CAT_DEF,    "Allows editing of module or data object parameters. The parameters are written just as they would be ordinarily." },
    { DEF_INPUTEDITOR,  "input_editor",     CAT_DEF,    "Allows editing of module inputs after module creation. The connections are written just as they would be ordinarily." },
    ...
    { DEF_GROUP,        "group",            CAT_DEF,    "Groups a series of modules together allowing the copier to be used more efficiently. Connections are updated where appropriate to use the newly created modules." },
