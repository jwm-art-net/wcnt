...
namespace errors
{
 ...
 {
    { ERR_TYPE,         "BAD_ERROR_TYPE",   CAT_ERR_TYPE,               "Erroneous error!"  ,0 },
    { NO_ERROR,         "Ok",               CAT_NO_ERROR,               "No error occurred." ,0 },
    // CAT_NUM_OUT_OF_RANGE: "exceeds range..."
    { RANGE_0_1,        "0.0 ~ 1.0",        CAT_NUM_OUT_OF_RANGE,       0   ,0 },
    { RANGE_M1_1,       "-1.0 ~ 1.0",       CAT_NUM_OUT_OF_RANGE,       0   ,0 },
    { RANGE_FEED,       "-2.0 ~ 2.0",       CAT_NUM_OUT_OF_RANGE,       0   ,0 },
    { RANGE_DEGS,       "0.0 ~ 360.0",      CAT_NUM_OUT_OF_RANGE,       0   ,0 },
    { RANGE_SEMI,       "-12.0 ~ 12.0",     CAT_NUM_OUT_OF_RANGE,       0   ,0 },
    { RANGE_SEMI2,      "-24.0 ~ 24.0",     CAT_NUM_OUT_OF_RANGE,       0   ,0 },
    ...
    { RANGE_FMOD,       "0.0 ~ 32.0",           CAT_NUM_OUT_OF_RANGE_OR_EQ, 0   ,0 },
    { RANGE_FREQ,       "0.0 ~ 1/4 sample rate",CAT_NUM_OUT_OF_RANGE_OR_EQ, 0   ,0 },
    // CAT_NUM_BELOW: "must be... "
    { NEGATIVE,         "positive",     CAT_NUM_BELOW,  0   ,0 },
    { NEG_OR_ZERO,      "above zero",   CAT_NUM_BELOW,  0   ,0 },
    { ABOVE1,           "above 1.0",    CAT_NUM_BELOW,  0   ,0 },
    { LESS_THAN,        "more than",    CAT_NUM_BELOW,  0   ,0 },
    { ATLEAST2,         "atleast two",  CAT_NUM_BELOW,  0   ,0 },
    // CAT_COULD_NOT: "could not be..."
    { NO_OPEN,          "opened",       CAT_COULD_NOT,  0   ,0 },
    { NO_ADD,           "added",        CAT_COULD_NOT,  0   ,0 },
    // CAT_INVALID:  "invalid..."
