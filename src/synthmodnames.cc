...
namespace synthmod
{
 const struct names::gn_data names::data[LAST_TYPE] =
 {
    ...
    { CLOCK,            "clock",            0, "A basic clock source providing a phase trigger and phase step outputs."              },
    { CONSTMOD,         "constant",         0, "Provides a constant unchanging value."                                         },
    { FREQGEN,          "freq_generator",   0, "Translate one signal value range to a different value range." },
    { LFOCLOCK,         "lfo_clock",        0, "A clock with phase reset and dual modulation inputs." },
    ...
    { TRIWAVE2,         "tri_wave2",        0, "Triangle waveform with ramps set to a specific frequency. Low frequencies approach a square-wave shape, and high frequencies are treated to a psuedo low pass filter type effect." },
    ...
    { WCNTSIGNAL,       "wcnt_signal",      0, "A connective module mainly useful with the concept of entry points." },
    ...
    { DELAY,            "delay",            0, "Takes a signal and delays it, with various amplitude modulation options." },
    { SIMPLEDELAY,      "simple_delay",     0, "Simple delay, delays a signal and nothing more." },
    ...
    { NOTETRAN,         "note_tran",        0, "Performs some sort of difficult to comprehend translation of note data! (add -v switch to make sense of this.)" },
    ...
    { WCNTTRIGGER,      "wcnt_trigger",     0, "A connective module mainly useful for the concept of entry points." },
