...
class dobjdobjlist
{
 public:
	...
	dobjdobj* goto_first() { return dobj_dobj = (dobjdobj*)
			(dobjdobj_item = dobjdobj_list->goto_first())->get_data();}
	dobjdobj* goto_last() { return dobj_dobj = (dobjdobj*)
			(dobjdobj_item = dobjdobj_list->goto_last())->get_data();}
	dobjdobj* goto_prev() { return dobj_dobj = (dobjdobj*)
			(dobjdobj_item = dobjdobj_list->goto_prev())->get_data();}
	dobjdobj* goto_next(){ return dobj_dobj = (dobjdobj*)
