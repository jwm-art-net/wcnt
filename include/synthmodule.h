...
// code the outputs to inputs, etc, but that's ok when you just want to test
// the thing.
...
// although many synthmodules do not need access to much of the register_xxx
// stuff, you can use synthmod to access them.  Anything that needs access to
// synthmodlist or connector list will need access to synthmod anyhow.
...
class synthmod
{
 public:
	...
	// validation		   
	virtual bool validate(){return (valid = true);};
	void invalidate(){valid = false;}
	bool is_valid() { return valid;}
	const string* get_error_msg(){ return err_msg;}
	#ifndef BARE_MODULES
	// more virtuals
	...
	#endif
 protected:
//	#ifndef BARE_MODULES // called by derived class constructor
//	virtual void create_params(){};
//	virtual void create_moddobj(){};
//	#endif - don't think these need to be virtuals - or here
	string* err_msg;
 private:
