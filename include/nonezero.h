...
/*
	...
	the plan is that it should not be an option for the user to create them, infact
	the user should not be aware that there is such a module.
	I've designed it as a module so that when the user selects an output to plugin,
	there is the option to have none, or zero, same difference.
	
	when I programmed in TURBO_C++_v3.00 I found no problem with using NULL instead
	of a pointer to a var whose value was 0 - zero. Using GNU C++ v2.95 that
	creates seg faults.  But I was already aware that I needed a better solution
	so created the nonezero module.......
*/
