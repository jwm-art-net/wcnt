...
class dobjparamlist
{
 public:
	...
	dobjparam* add_dobjparam(dobjnames::DOBJ_TYPE, dparnames::DPAR_TYPE);
	dobjparam* goto_first(){ return (dpar = (dobjparam*)
		(dpar_item = dpar_list->goto_first())->get_data());}
	dobjparam* goto_last(){ return (dpar = (dobjparam*)
		(dpar_item = dpar_list->goto_last())->get_data());}
	dobjparam* goto_prev(){ return (dpar = (dobjparam*)
		(dpar_item = dpar_list->goto_prev())->get_data());}
	dobjparam* goto_next(){ return (dpar = (dobjparam*)
