...
class modoutputlist
{
  public:
	...
	modoutput* goto_first(){ return output = (modoutput*)(output_item = outlist->goto_first())->get_data();}
	modoutput* goto_last(){ return output = (modoutput*)(output_item = outlist->goto_last())->get_data();}
	modoutput* goto_prev(){ return output = (modoutput*)(output_item = outlist->goto_prev())->get_data();}
	modoutput* goto_next(){ return output = (modoutput*)(output_item = outlist->goto_next())->get_data();}
...
modoutputlist* list_of_category_orderpref
(
IOCAT out_cat,  								//category type to list
synthmodnames::SYNTH_MOD_TYPE * sm_prefs, 	//NULL terminated array of modules to list first 
outputnames::OUT_TYPE* out_prefs, 				//NULL terminated array of output types to list first 
