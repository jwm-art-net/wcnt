...
class stereomixer: public synthmod
{
 public:
	...
	stereo_channel* goto_first_left_channel(){ return (stereo_channel*)chlist.goto_first()->get_data();}
	stereo_channel* goto_last_left_channel(){ return (stereo_channel*)chlist.goto_last()->get_data();}
	stereo_channel* goto_prev_left_channel(){ return (stereo_channel*)chlist.goto_prev()->get_data();}
	stereo_channel* goto_next_left_channel(){ return (stereo_channel*)chlist.goto_next()->get_data();}
