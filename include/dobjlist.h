...
class dobjlist
{
 public:
	...
	dobj* goto_first() { return d_obj = (dobj*)
		(dobj_item = dobj_list->goto_first())->get_data();}
	dobj* goto_last() { return d_obj = (dobj*)
		(dobj_item = dobj_list->goto_last())->get_data();}
	dobj* goto_prev() { return d_obj = (dobj*)
		(dobj_item = dobj_list->goto_prev())->get_data();}
	dobj* goto_next() { return d_obj = (dobj*)
		(dobj_item = dobj_list->goto_next())->get_data();}
	dobj* get_dobj_by_name(const string*);
