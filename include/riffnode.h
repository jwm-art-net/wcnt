...
/* 
	...
	riffs are n't tied to any particular sequencer.	therefore, sequencer cannot 
	use the riff's own methods for navigating through the notes. in theory,
	one riff could potentially be used by multiple sequencers simultaneously
	which could possibly be running at different tempos and/or time signatures.
	...
	*** removed start velocity and end velocity ***
	...
	and hold module, could achieve the same effect.
