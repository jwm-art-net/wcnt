...
class dynamic : public synthmod 
{
 public:
	...
	dynvertex* goto_first() { return dvtx = (dynvertex*)
		(dvtx_item = dynamics->goto_first())->get_data();}
	dynvertex* goto_last(){ return dvtx = (dynvertex*)
		(dvtx_item = dynamics->goto_last())->get_data();}
	dynvertex* goto_prev(){ return dvtx = (dynvertex*)
		(dvtx_item = dynamics->goto_prev())->get_data();}
	dynvertex* goto_next(){ return dvtx = (dynvertex*)
		(dvtx_item = dynamics->goto_next())->get_data();}
	dynvertex* get_first(){ return (dynvertex*)
		(dynamics->sneak_first())->get_data();}
	dynvertex* get_last(){ return (dynvertex*)
		(dynamics->sneak_last())->get_data();}
	dynvertex* get_prev(){ return (dynvertex*)
		(dynamics->sneak_prev())->get_data();}
	dynvertex* get_next(){ return (dynvertex*)
		(dynamics->sneak_next())->get_data();}
